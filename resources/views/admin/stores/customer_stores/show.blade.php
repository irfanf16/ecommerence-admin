@extends('admin.layouts.master', ['navItem' => 'customer', 'module' => 'Customers'])
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header border-0">
                <h3 class="mb-0 text-center">Customer Profile Information
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>Street Number</th>
                                    <td>{{ $address->user_street_no ?? null  }}</td>
                                     <th>Building Number</th>
                                    <td>{{ $address->user_building_no ?? null  }}</td>
                                    <th>Floor Number</th>
                                    <td>{{ $address->user_floor_no ?? null }}</td>
                                </tr>
                                <tr>
                                    {{-- @dd($address) --}}
                                   <th>Apartment Number</th>
                                    <td>{{ $address->user_appartment_no ?? null }}</td> 
                                    <th>Address (Optional)</th>
                                    <td colspan="4">{{ $address->user_address ?? null }}</td> 
                                </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    <th>Store Name</th>
                                 <td>{{ $customer_store->name ?? null }}</td>
                                 <tr>
                                    <th>Code</th>
                                    <td>
                                        {{ $customer_store->code ?? null }}
                                    </td>
                                </tr>
                                    {{-- <th>Category</th> --}}
                                ...
                                <tr>
                                    <th>Short Desc</th>
                                    <td colspan="6">
                                        {{ $customer_store->description ?? null }}
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    {{-- <div class="row">
                        ...
                        <div class="col-md-12"> --}}
                            ...
                            {{-- <form action='{{ URL::to("admin/vendor/profile/update-status/$profile_details->id") }}'
                                method="post">
                                <div class="row">
