...
@section('title', 'Vendor Store Information')
                ...
                <div class="col-md-12">
                        ...
                        <div class="col-lg-12">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <th>Owner Email:</th>
                                    <td>{{ $store->vendor_details->email }}</td>
                                    <th>Owner Mobile:</th>
                                    <td>{{ $store->vendor_details->mobile }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <a href="{{ URL::to("admin/stores/vendor")  }}" class="btn btn-primary d-inline float-right">Back</a>
