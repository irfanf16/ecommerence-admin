@extends('admin.layouts.master', ['navItem' => 'vendors', 'module' => 'requests'])
@section('title', 'Under Review Vendors Profiles ')
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card border">
                    <div class="header">
                        <h2><strong>Vendor Review Profiles - {{ $vendors['under_review_vendors_count'] }}</strong></h2>
                    </div>
                    <div class="body">
                        <div class="table-responsive">
                            <table id="example-datatable" class="table table-hover dataTable js-basic-example">
                                ...
                                <tbody>
                                    @php $count = 1; @endphp
                                    @foreach ($under_review_vendors->vendors as $vendor)
                                        <tr>
                                            <td>{{ $count }}</td>
                                            <td>
