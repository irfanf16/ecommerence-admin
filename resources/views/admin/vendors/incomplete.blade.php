...
@section('title', 'Incomplete Vendors Profiles ')
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card border">
                    <div class="header">
                        <h2><strong>Incomplete Vendor Profiles - {{ $vendors['incomplete_vendors_count'] }}</strong></h2>
                    </div>
                    <div class="body">
                        <div class="table-responsive">
                            <table id="example-datatable" class="table table-hover dataTable js-basic-example">
                                ...
                                <tbody>
                                    @php $count = 1; @endphp
                                    @foreach ($incomplete_vendors->vendors as $vendor)
                                        <tr>
                                            <td>{{ $count }}</td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="{{ URL::to("admin/vendor/profile/incomplete/$vendor->id") }}"
