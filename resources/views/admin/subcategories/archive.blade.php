@extends('admin.layouts.master', ['navItem' => 'categories', 'module' => 'Sub Categories'])
@section('title', 'Archived Sub Categories ')
            ...
            <div class="col-lg-12">
                <div class="card border-0">
                    <div class="header justify-content-center">
                        <h2 class="text-center"><strong> Sub Categories</strong></h2>
                                        ...
                                        <tr>
                                            ...
                                            <td width="10%">
                                                @if ($subcategory->image)
                                                    <img src='{{ config('app.url') . "admin/images/subcategories/sm/$subcategory->image" }}'
                                            ...
                                            <td width="18%">
                                                ...
                                                <form id="archive-{{ $subcategory->id }}"
                                                    action="{{ URL::to('admin/subcategory/restore') }}" method="POST"
                                                    class="d-inline">
                                                    @csrf
