...
@section('title', 'All Cart Items List')
@section('content')
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card border">
                    <div class="header">
                        <h2><strong> Cart Items List </strong></h2>
                    </div>
                        ...
                        <div id="DataTables" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            <div class="row mb-5 mt-5 page-block">
                                <div class="col-sm-12 col-md-4 mt-2">
                                    <label>From:</label>
                                    <input id="cartItem_from_date" value="{{ Session::get('cartItem_from_date') }}" type="date"
                                           class="form-control cartItem_filters">
                                </div>
                                <div class="col-sm-12 col-md-4 mt-2">
                                    <label>To:</label>
                                    <input id="cartItem_to_date" value="{{ Session::get('cartItem_to_date') }}" type="date"
                                           class="form-control cartItem_filters">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="dataTables_length"><label>Show
                                            <select id="cartItems_datatable_length" name="datatable_length"
                                                    class="form-control form-control-sm cartItem_filters">
                                                <option
                                                    {{ Session::get('cartItem_datatable_length') == 10 ? 'selected' : '' }}
                                                    value="10">
                                                    10
                                                </option>
                                                <option
                                                    {{ Session::get('cartItem_datatable_length') == 25 ? 'selected' : '' }}
                                                    value="25">
                                                    25
                                                </option>
                                                <option
                                                    {{ Session::get('cartItem_datatable_length') == 50 ? 'selected' : '' }}
                                                    value="50">
                                                    50
                                                </option>
                                                <option
                                                    {{ Session::get('cartItem_datatable_length') == 100 ? 'selected' : '' }}
                                                    value="100">
                                                    100
                                                </option>
                            ...
                            <div class="row" id="cartItemPaginationList">
                            </div>
                        </div>
                    </div>
                </div>
...
@section('customScripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            var page_id = 1;
            @if (Session::has('cartItem_page_id'))
                page_id = '{{ Session::get('wishlist_page_id') }}'
            @endif
            getCartItems(page_id);
        });
